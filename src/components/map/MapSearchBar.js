    ...
    <div className={styles.search}>
      <button className={styles.dropbtn}>{selectValue}</button>
        <div className={styles.dropdownContent}>
            <option value="전체" onClick={selectBoxChange}>전체</option>
            <option value="여행지" onClick={selectBoxChange}>여행지</option>
            <option value="음식점" onClick={selectBoxChange}>음식점</option>
      </div>
      <input
        type="text"
        id="search"
